...
Revision ID: 38469a532f4a
Revises: 
Create Date: 2025-03-03 23:54:11.543213
...
def upgrade() -> None:
    ...
    op.create_table('temporary_reservations',
    sa.Column('start', sa.Date(), nullable=False),
    sa.Column('end', sa.Date(), nullable=False),
    sa.Column('full_price', sa.Integer(), nullable=False),
    sa.Column('was_paid', sa.Boolean(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('temporary_reservations')
